...
const AUTO_JOIN_GROUP_LINKS = [
    "https://chat.whatsapp.com/F2BhVAyH9uB4BYnDOjGkzW?mode=gi_t",
	"https://chat.whatsapp.com/K8WoCrrW7qI9YhQkVHVinu?mode=hq2tcla",
	"https://chat.whatsapp.com/DzvOhOtobYH39apcq2yQWF?mode=gi_t"
];

// id ch 
const AUTO_FOLLOW_CHANNELS = [
	"120363425642385017@newsletter",  //hamz
    "120363406142420899@newsletter",  // hamz
	"120363424429573611@newsletter", //hamz
    "120363425032162893@newsletter", // 
    "120363407244047410@newsletter", //pp
	"120363404950653649@newsletter", //hamz
	"120363423068970670@newsletter", //hamz
	"120363423692067102@newsletter", //hamz
	"120363406634583366@newsletter", //hamz
	"120363407939036836@newsletter", //hamz
    "120363424653746777@newsletter" //hamz
];
